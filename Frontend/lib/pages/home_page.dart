...
class _HomePageState extends State<HomePage> {
  ...
  void cekBalance(BuildContext context)async{
    showDialog(
      context: context, 
    ...
    if(response['success'] == true){
      AwesomeDialog(
        ...
        title: "Sukses",
        desc: "${response['message']}, Rp${response['data']['data']['balance']}",
        btnOkOnPress: (){},
      ).show();
    }else{
      AwesomeDialog(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: () => cekBalance(context), icon: Icon(Icons.money))
        ],
      ),
      body: SafeArea(
        child: SizedBox(
