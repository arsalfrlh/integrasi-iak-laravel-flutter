...
class BeliPage extends StatefulWidget {
  BeliPage({required this.pricelist});
  Pricelist pricelist;
...
class _BeliPageState extends State<BeliPage> {
  ...
  void _beli(BuildContext context)async{
    if(kostumerID.text.isNotEmpty && widget.pricelist.codeProduk.isNotEmpty){
      showDialog(
        context: context, 
        barrierDismissible: false,
        builder: (context) => const Center(child: CircularProgressIndicator(),));

      final newBeli = Pricelist(
        codeProduk: widget.pricelist.codeProduk,
        kostumerID: kostumerID.text,
      );
      final response = await apiService.beliProduk(newBeli);
